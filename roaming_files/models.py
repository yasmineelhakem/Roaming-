...
class RoamingIn(models.Model):
    input_file = models.FileField(upload_to='roaming_in_files/inputs',null=True)
    output_file = models.FileField(upload_to='roaming_in_files/outputs', null=True, blank=True)
