...
def update_graphs(_):
    ...
    fig_vlrs_operator.update_layout(
        title={
            'text': 'Repartition of VLRs per Operator',
            'font': {'size': 30},
            'x': 0.5,
            'xanchor': 'center'
        },
    ...
    fig_subs_operator.update_layout(
        title={
            'text': 'Repartition of Subscribers per Operator',
            'font': {'size': 30},
            'x': 0.5,
            'xanchor': 'center'
        },
